...
DIR    = os.getcwd() + '/'
pathlist = glob.glob(DIR+'*_slab.d12')
nDIR     = len(DIR)
ntype    = len("_slab.out")
...
for path in pathlist:
    ...
    if material == "":break
    print(material)
    space = float(input("Insert distance between ghost atoms and slab (Angstoms): "))
    SLABd12  = material+"_slab.d12"
    new_SLABd12 = material+'_'+str(space)+"A_ghosts_slab.d12"
